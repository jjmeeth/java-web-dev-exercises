...
public class Case {
    ...
    public Case(){
        ...
        Toppings toppings1 = new Toppings("hot fudge", .50, new ArrayList<>(Arrays.asList("none")));
        Toppings toppings2 = new Toppings("sprinkles", .25, new ArrayList<>(Arrays.asList("red #5")));
        Toppings toppings3 = new Toppings("nuts", .10, new ArrayList<>(Arrays.asList("nuts")));
        Toppings toppings4 = new Toppings("berries", 1.00, new ArrayList<>(Arrays.asList("strawberry, rasberry, blueberry")));
